...
func is_valid_profile() -> bool:
	return lane_count == 3 and lane_spacing > 0.0 and base_speed >= 0.0 and max_speed >= base_speed and lane_change_duration > 0.0 and jump_duration > 0.0 and slide_duration > 0.0 and sliding_height <= standing_height
