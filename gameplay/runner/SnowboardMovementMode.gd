class_name SnowboardMovementMode
extends MovementMode

## SNOWBOARD keeps the shared runner/input contract while profile data supplies
## its looser lateral timing and snow-route speed values.
